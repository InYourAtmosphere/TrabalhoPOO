...
public class NovoClienteDialog extends JDialog {
    ...
    public NovoClienteDialog(Window owner, Runnable aoSalvarComSucesso) {
        super(owner, "Novo Cliente", ModalityType.APPLICATION_MODAL);
    ...
    private void salvar() {
        ...
        new SwingWorker<ApiClient.ApiResponse, Void>() {
            ...
            protected ApiClient.ApiResponse doInBackground() throws Exception {
                ...
                return ApiClient.post("/clientes", json);
            }
